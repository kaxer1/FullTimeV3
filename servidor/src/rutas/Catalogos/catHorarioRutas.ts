...
class HorarioRutas {
    ...
    configuracion(): void {
        ...
        this.router.get('/verificarDuplicados/:nombre', TokenValidation, HORARIO_CONTROLADOR.VerificarDuplicados);
        this.router.get('/verificarDuplicados/edicion/:id/:nombre', TokenValidation, HORARIO_CONTROLADOR.VerificarDuplicadosEdicion);
